...
{
	public static <T> String AppendQueryParameters(String url, final Map<String, T> parameters) throws UnsupportedEncodingException
	{
		return AppendQueryParameters(url, parameters, null);
	}

	public static <T> String AppendQueryParameters(String url, final Map<String, T> parameters, final String encoding)
